下面看不懂，那也很正常，运行simpledb目录下的server目录下的StartServer.java
...
I. Release Notes:
  ...
  This release of the SimpleDB system is Version 3.3, which was
  uploaded on January 13 2020.  This release contains minor revisions 
  of the 3.2 code, and corresponds to the code in the revised version
  of my textbook "Database Design and Implementation".
